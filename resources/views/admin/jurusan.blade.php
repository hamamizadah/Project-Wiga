            ...
            <div class="card-footer text-right">
                {{-- <nav class="d-inline-block">
                    <ul class="pagination mb-0">
                        @if ($jurusans->currentPage() <= 1)
                            <li class="page-item disabled">
                                <a class="page-link" href="#" tabindex="-1"><i class="fas fa-chevron-left"></i></a>
                            </li>
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $jurusans->previousPageUrl() }}"><i
                                        class="fas fa-chevron-left"></i></a>
                            </li>
                        @endif

                        @for ($page = max($jurusans->currentPage() - 1, 1); $page <= min($jurusans->currentPage() + 1, $jurusans->lastPage()); $page++)
                            @if ($page == $jurusans->currentPage())
                                <li class="page-item active"><a class="page-link"
                                        href="{{ $jurusans->url($page) }}">{{ $page }}</a></li>
                            @else
                        ...
                        @if ($jurusans->currentPage() >= $jurusans->lastPage())
                            <li class="page-item disabled">
                                <a class="page-link" href="#"><i class="fas fa-chevron-right"></i></a>
                            </li>
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $jurusans->nextPageUrl() }}"><i
